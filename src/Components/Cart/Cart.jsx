...
const Cart = () => {
  ...
  const { Clearcart, cart, removeItemsFromcart,updateCartQuantity } = useCart()
  console.log(cart);
  


  const handleQuanityChange=(itemId,currStock,change)=>{
    ...
    <>
      {
        cart.length === 0 ? (
          <>
            <div className="flex flex-row justify-center items-center h-screen font-bold gap-4">
                            ...
                            <div className="rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 md:p-6">
                              <div className="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                                <a href="#" className="shrink-0 md:order-1">
                                  <img
                                    className="h-40 w-52 dark:hidden"
                                    src={cartItems.thumbnail}
                                    alt="imac image"
                                  />
                                  <img
                                    className="hidden h-40 w-52 dark:block"
                                    src={cartItems.thumbnail}
                                    alt="imac image"
                                  />
                                </a>
                                ...
                                <div className="flex items-center justify-between md:order-3 md:justify-end">
                                  <div className="flex items-center">
                                    <button onClick={()=>handleQuanityChange(cartItems.id,cartItems.quantity,-1 )}
                                      type="button"
                                      id="decrement-button"
                                    ...
                                    {/* <input
                                      ...
                                      required=""
                                    /> */}
                                    <span className="px-2">{cartItems.quantity}</span>
                                    <button  onClick={()=>handleQuanityChange(cartItems.id,cartItems.quantity,+1 )}
                                      type="button"
                                      id="increment-button"
                                ...
                                <div className="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
                                  ...
                                  <div className="flex items-center gap-4">
                                    ...
                                    <button onClick={() => removeItemsFromcart(cartItems.id)}
                                      type="button"
